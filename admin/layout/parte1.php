...
<head>
  ...
  <link rel="stylesheet" href="<?=APP_URL?>/public/plugins/fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome Icons -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=APP_URL?>/admin" class="brand-link">
      <img src="https://e7.pngegg.com/pngimages/692/183/png-clipart-computer-icons-college-square-academic-cap-school-school-cdr-angle-thumbnail.png"
       alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 1">
